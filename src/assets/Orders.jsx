...
const Orders = () => {
  ...
  useEffect(() => {
    ...
    const remainTodayOrders = orders.filter(
      (item) => item.orderDate === formattedDate
    );
          ...
          <>
            {todayOrders.length > 0 ? (
                ...
                {todayOrders.map((item) => (
                  ...
                  >
                    ...
                    <h6 className="text-gray-600 mt-1">
                      ...
                      <span
                        className={`font-semibold capitalize ${
                          item.orderStatus === "pending"
                            ? "bg-white text-orange-700 rounded p-1 px-2"
                            : ""
                        }
                     ${
                     ...
                     ${
                      ...
                      ${
                       ...
                       ${
                         item.orderStatus === "outofdelivery"
                           ? "bg-green-600 text-white rounded p-1 px-2"
                           : ""
                       }`}
                      >
                    ...
                    <h6 className="text-gray-600 mt-1">
                      Address :{" "}
                      <span className="font-semibold capitalize text-black">
                        {item.shippingAddress[0].village}
                      </span>
                    </h6>
                    <h6 className="text-gray-600 mt-1">
                      Mobile :{" "}
                      <span className="font-semibold capitalize text-black">
                        {item.shippingAddress[0].phone}
                      </span>
                    </h6>
                    <h6 className="text-gray-600 mt-1">
                      Ordered date :{" "}
              ...
              <div className="flex justify-center items-center w-full h-[50vh]">
                <h5 className="text-[1.2rem] font-semibold">No Orders</h5>
              </div>
            )}
          </>
        )}
